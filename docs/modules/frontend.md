...
| `components/GitPanel.tsx` | Git status dropdown panel showing branch, commits, staged/unstaged changes, untracked files, stash, and local branch switching with an explicit Switch button. |
