...
| `components/GitCommitDiffModal.tsx` | Large read-only modal for one selected commit file diff, including loading/error/binary/too-large fallback states and unified diff display. |
